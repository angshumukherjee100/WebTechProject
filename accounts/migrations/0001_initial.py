# Generated by Django 2.0.5 on 2018-11-13 14:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('demandValue', models.PositiveIntegerField(default=0, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='distanceMatrix',
            fields=[
                ...
                ('fromLocation', models.CharField(choices=[('ap', 'Airport'), ('ba', 'Baguiati'), ('lt', 'Lake Town'), ('bg', 'Beleghata'), ('rh', 'Ruby Hospital')], max_length=150, null=True)),
                ('toLocation', models.CharField(choices=[('ap', 'Airport'), ('ba', 'Baguiati'), ('lt', 'Lake Town'), ('bg', 'Beleghata'), ('rh', 'Ruby Hospital')], max_length=150, null=True)),
                ('distance', models.DecimalField(blank=True, decimal_places=2, default=0.0, max_digits=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='driver',
            fields=[
                ...
                ('license', models.CharField(max_length=150, null=True)),
                ('vehicleName', models.CharField(max_length=150, null=True)),
                ('state', models.BooleanField(default=False)),
                ('vehicleNumber', models.CharField(max_length=150, null=True)),
                ('rating', models.DecimalField(blank=True, decimal_places=1, default=0.0, max_digits=3, null=True)),
                ('carType', models.CharField(choices=[('eco', 'Economic'), ('prem', 'Premium'), ('suv', 'SUV')], max_length=100, null=True)),
